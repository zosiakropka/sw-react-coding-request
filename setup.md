...
You'll need a functioning [Node.js](https://nodejs.org/en/) environment with [npm](https://www.npmjs.com) installed to use this project scaffold. Next, install the project dependencies:
